...
# # # install this for the lat/long field
# # echo "============================================================================"
# # echo "Installing logstash-filter-mutate"
# # /opt/logstash/bin/logstash-plugin install logstash-filter-mutate
